    ...
    <section id="analytics" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-[1fr_1fr] lg:items-center">
          <Reveal>
            <div className="flex flex-col rounded-2xl border border-(--color-border-main)/70 bg-(--color-bg-surface)/90 p-4 shadow-[0_22px_80px_-40px_rgba(124,108,246,0.3)] backdrop-blur-xl">
              {/*

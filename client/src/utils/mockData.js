...
const buildMockTransactions = () => {
  ...
  [12, 27, 49, 71].forEach((n) =>
    add(n, "Entertainment", 32 + (n % 40), "expense", "Movie / event"),
  );
...
export const mockInsights = [
      ...
      recommendations: [
        {
          ...
          detail:
            "Avoid new non-essential purchases for the next two weeks to bring Shopping back under budget.",
        },
        {
          title: "Move $1,500 to savings",
          detail:
            "Based on your projected end-of-month surplus, you can safely transfer $1,500 to your savings account.",
        },
        {
          title: "Set a weekly food limit",
          detail:
            "Aim for ~$80/week on Food & Dining to leave headroom for one weekend dinner out.",
        },
      ],
  ...
  },
  {
    ...
    content_json: {
      overallTip:
        "Small daily wins on coffee and dining out could free up ~$120/mo without any lifestyle change.",
      tips: [
        {
          category: "Food & Dining",
          title: "Brew at home twice a week",
          detail:
            "Replacing two coffee shop visits per week with home-brew saves about $40/month.",
          estimatedSavings: 40,
        },
        {
          ...
          detail:
            "You're paying for Netflix, Spotify, and YouTube Premium. Drop one and save the monthly fee.",
          estimatedSavings: 16,
        },
        {
          ...
          detail:
            "Combining short rides into one weekly trip can cut transportation costs by ~$25/month.",
          estimatedSavings: 25,
        },
        {
          category: "Shopping",
          ...
          detail:
            "Add non-essentials to a wishlist for 24 hours before buying. Avoids ~$40/mo in impulse buys.",
          estimatedSavings: 40,
        },
      ],
    },
...
export const mockInsightGenerators = {
  monthly_summary: {
    ...
    recommendations: [
      {
        title: "Freeze Shopping for two weeks",
        detail:
          "Pause non-essential purchases to recover the $20 overage and finish the month under budget.",
      },
      {
        title: "Transfer surplus to savings",
        detail:
          "Set up an automatic $1,500 transfer at month end to lock in the surplus before it leaks.",
      },
      {
        title: "Consolidate subscriptions",
        detail:
          "Drop one of Netflix, Spotify, or YouTube Premium for a quick $11–16/month win.",
      },
    ],
    topSpendingCategory: "Rent",
    estimatedMonthlySavings: 240,
  ...
  savings_tips: {
    overallTip:
      "Your top three leak categories are dining, subscriptions, and impulse shopping — small habit shifts here unlock ~$120/mo.",
    tips: [
      {
        category: "Food & Dining",
        title: "Brew coffee twice a week at home",
        detail:
          "Two home-brew swaps per week cut monthly coffee spend by about $40.",
        estimatedSavings: 40,
      },
      {
        category: "Entertainment",
        title: "Drop one streaming service",
        detail:
          "Three active subscriptions is overkill. Pick the one you actually use most this quarter.",
        estimatedSavings: 16,
      },
      {
        category: "Transportation",
        title: "Plan weekly errands together",
        detail:
          "Combining trips into one Uber/rideshare per week reduces transportation overhead.",
        estimatedSavings: 25,
      },
      {
        category: "Shopping",
        ...
        detail:
          "Add non-essentials to a wishlist; revisit after 24 hours. Most impulse buys fade.",
        estimatedSavings: 40,
      },
    ],
  },
  budget_alert: {
    ...
    message:
      "You've used $320 of your $400 Food & Dining budget with 17 days left in the month. At your current pace, you'll go over by about $30.",
    suggestions: [
...
export const mockBudgetAnalyses = [
  {
    ...
    status: "good",
    message:
      "You've spent $320 of your $400 Food & Dining budget — right on pace with two weeks left.",
  },
  {
    budgetId: 2,
    status: "good",
    message:
      "Groceries are comfortably under budget at $262 of $400. Nice consistent pace.",
  },
  {
    budgetId: 3,
    status: "caution",
    message:
      "Entertainment is at $80 of $100 — close to the limit with a few weeks left. Watch new subscriptions.",
  },
  {
    budgetId: 4,
    status: "good",
    message: "Transportation usage is healthy at $139 of $250.",
  },
  {
    budgetId: 5,
    status: "concerning",
    message:
      "Shopping has exceeded its $100 cap by $20. Consider pausing non-essentials until next month.",
  },
];
